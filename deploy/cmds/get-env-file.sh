...
# deployment-dir: required. e.g. local-dev gets placed in compose/ucdlib-intranet-local-dev/.env
###
...
DEPLOYMENT_DIR="../compose/ucdlib-intranet-$DEPLOYMENT_DIR"
...
gcloud --project=digital-ucdavis-edu secrets versions access latest --secret=ucdlib-intranet-env > "$ENV_FILE"
